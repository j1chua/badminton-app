    ...
    try:
        ...
        for idx, row in df.iterrows():
            ...
            for c in blocks:
                ...
                # Shortened ID to prevent editor clipping crashes
                m_id = f"{court[:3]}{color[:3]}{idx}{c[0]}"
                ...
                # THE SCORE FIX: Forces Python to see "21" and "16" separately
                sc = []
                ...
                db[m_id] = {"s1":sc[0], "s2":sc[1], "s3":sc[2], "s4":sc[3], "t1":t1, "t2":t2, "p1":sc[0]+sc[1], "p2":sc
