        ...
        for idx, row in df.iterrows():
            ...
            for c in blocks:
                try:
                    ...
                    # ID split into parts to prevent long-line clipping
                    ...
                    # Score Parsing (Supports the decimal scores in your CSV)
...
if sch is None or sch.empty:
    ...
    with tab1:
        ...
        for color in sorted(df_r["Bracket"].unique()):
            ...
            # Rank generation on separate lines to avoid clipping errors
            rank_col = [get_rank_str(i+1) for i in range(len(sdf))]
            sdf.insert(0, "Rank", rank_col)
